...
void _budgetModelSerialize(
  ...
  writer.writeDouble(offsets[0], object.carryOverAmount);
  ...
  writer.writeBool(offsets[7], object.rollover);
...
BudgetModel _budgetModelDeserialize(
  ...
  object.carryOverAmount = reader.readDouble(offsets[0]);
  object.categoryId = reader.readLongOrNull(offsets[1]);
  object.createdAt = reader.readDateTime(offsets[2]);
  object.currency = reader.readString(offsets[3]);
  object.id = id;
  object.isActive = reader.readBool(offsets[4]);
  object.limitAmount = reader.readDouble(offsets[5]);
  object.period =
      _BudgetModelperiodValueEnumMap[reader.readByteOrNull(offsets[6])] ??
          BudgetPeriod.weekly;
  object.rollover = reader.readBool(offsets[7]);
...
const _BudgetModelperiodValueEnumMap = {
  ...
  1: BudgetPeriod.biweekly,
  2: BudgetPeriod.monthly,
  3: BudgetPeriod.quarterly,
...
extension BudgetModelByIndex on IsarCollection<BudgetModel> {
  Future<BudgetModel?> getByCategoryId(int? categoryId) {
    return getByIndex(r'categoryId', [categoryId]);
  }

  BudgetModel? getByCategoryIdSync(int? categoryId) {
  ...
  Future<List<BudgetModel?>> getAllByCategoryId(List<int?> categoryIdValues) {
    final values = categoryIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'categoryId', values);
  }

  List<BudgetModel?> getAllByCategoryIdSync(List<int?> categoryIdValues) {
    final values = categoryIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCategoryId(BudgetModel object) {
    return putByIndex(r'categoryId', object);
  }

  Id putByCategoryIdSync(BudgetModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'categoryId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCategoryId(List<BudgetModel> objects) {
    return putAllByIndex(r'categoryId', objects);
  }

  List<Id> putAllByCategoryIdSync(List<BudgetModel> objects,
      {bool saveLinks = true}) {
...
extension BudgetModelQueryWhereSort
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension BudgetModelQueryWhere
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterWhereClause> createdAtBetween(
...
extension BudgetModelQueryFilter
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterFilterCondition> rolloverEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'rollover',
...
extension BudgetModelQuerySortBy
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> sortByCarryOverAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> sortByRollover() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rollover', Sort.asc);
    });
  }

  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> sortByRolloverDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetModelQuerySortThenBy
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> thenByCarryOverAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carryOverAmount', Sort.asc);
    });
  }
  ...
  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> thenByRollover() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rollover', Sort.asc);
    });
  }

  QueryBuilder<BudgetModel, BudgetModel, QAfterSortBy> thenByRolloverDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rollover', Sort.desc);
    });
  }
...
extension BudgetModelQueryWhereDistinct
  ...
  QueryBuilder<BudgetModel, BudgetModel, QDistinct> distinctByRollover() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetModelQueryProperty
  ...
  QueryBuilder<BudgetModel, bool, QQueryOperations> rolloverProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension GetSpendingSplitModelCollection on Isar {
  IsarCollection<SpendingSplitModel> get spendingSplitModels =>
      this.collection();
}

const SpendingSplitModelSchema = CollectionSchema(
  name: r'SpendingSplitModel',
  id: 2889791133868485250,
  properties: {
  ...
  estimateSize: _spendingSplitModelEstimateSize,
  serialize: _spendingSplitModelSerialize,
  deserialize: _spendingSplitModelDeserialize,
  deserializeProp: _spendingSplitModelDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _spendingSplitModelGetId,
  getLinks: _spendingSplitModelGetLinks,
  attach: _spendingSplitModelAttach,
  version: '3.1.0+1',
);

int _spendingSplitModelEstimateSize(
  SpendingSplitModel object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  ...
  bytesCount += 3 + object.participant.length * 3;
  return bytesCount;
}

void _spendingSplitModelSerialize(
  SpendingSplitModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[4], object.participant);
  writer.writeLong(offsets[5], object.transactionId);
}

SpendingSplitModel _spendingSplitModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SpendingSplitModel();
  object.amount = reader.readDouble(offsets[0]);
  object.createdAt = reader.readDateTime(offsets[1]);
  object.id = id;
  object.isReimbursed = reader.readBool(offsets[2]);
  object.notes = reader.readStringOrNull(offsets[3]);
  object.participant = reader.readString(offsets[4]);
  object.transactionId = reader.readLong(offsets[5]);
  return object;
}

P _spendingSplitModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _spendingSplitModelGetId(SpendingSplitModel object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _spendingSplitModelGetLinks(
    SpendingSplitModel object) {
  return [];
}

void _spendingSplitModelAttach(
    IsarCollection<dynamic> col, Id id, SpendingSplitModel object) {
  object.id = id;
}

extension SpendingSplitModelQueryWhereSort
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QWhere> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }

  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterWhere>
      anyTransactionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension SpendingSplitModelQueryWhere
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QWhereClause> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterWhereClause>
      idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
...
extension SpendingSplitModelQueryFilter
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QFilterCondition> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterFilterCondition>
      amountEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterFilterCondition>
      participantContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'participant',
        value: value,
  ...
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterFilterCondition>
      participantMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'participant',
        wildcard: pattern,
...
extension SpendingSplitModelQueryObject
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QFilterCondition> {}

extension SpendingSplitModelQueryLinks
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QFilterCondition> {}

extension SpendingSplitModelQuerySortBy
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QSortBy> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterSortBy>
      sortByAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterSortBy>
      sortByParticipant() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'participant', Sort.asc);
    });
  }

  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterSortBy>
      sortByParticipantDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'participant', Sort.desc);
    });
  }
...
extension SpendingSplitModelQuerySortThenBy
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QSortThenBy> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QAfterSortBy>
      thenByAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amount', Sort.asc);
...
extension SpendingSplitModelQueryWhereDistinct
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QDistinct> {
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QDistinct>
      distinctByAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SpendingSplitModel, SpendingSplitModel, QDistinct>
      distinctByParticipant({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'participant', caseSensitive: caseSensitive);
    });
  }
...
extension SpendingSplitModelQueryProperty
    on QueryBuilder<SpendingSplitModel, SpendingSplitModel, QQueryProperty> {
  QueryBuilder<SpendingSplitModel, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<SpendingSplitModel, double, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'amount');
    });
  }

  QueryBuilder<SpendingSplitModel, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  ...
  QueryBuilder<SpendingSplitModel, bool, QQueryOperations>
      isReimbursedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isReimbursed');
    });
  }

  QueryBuilder<SpendingSplitModel, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<SpendingSplitModel, String, QQueryOperations>
      participantProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SpendingSplitModel, int, QQueryOperations>
