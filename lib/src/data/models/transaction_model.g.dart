...
void _transactionModelSerialize(
  ...
  writer.writeBool(offsets[9], object.hasSplits);
  writer.writeBool(offsets[10], object.isManuallyEdited);
  writer.writeBool(offsets[11], object.isRecurring);
  writer.writeBool(offsets[12], object.isSubscription);
  writer.writeByte(offsets[13], object.kind.index);
  writer.writeDateTime(offsets[14], object.manualEditTimestamp);
  writer.writeString(offsets[15], object.merchantName);
  writer.writeString(offsets[16], object.notes);
  writer.writeByte(offsets[17], object.origin.index);
  writer.writeString(offsets[18], object.originalEmailId);
  writer.writeString(offsets[19], object.rawMerchantName);
  writer.writeLong(offsets[20], object.subscriptionId);
  writer.writeDouble(offsets[21], object.subtotalAmount);
  ...
  writer.writeBool(offsets[25], object.userVerified);
}
...
TransactionModel _transactionModelDeserialize(
  ...
  object.hasSplits = reader.readBool(offsets[9]);
  object.id = id;
  object.isManuallyEdited = reader.readBool(offsets[10]);
  object.isRecurring = reader.readBool(offsets[11]);
  object.isSubscription = reader.readBool(offsets[12]);
  object.kind =
      _TransactionModelkindValueEnumMap[reader.readByteOrNull(offsets[13])] ??
          TransactionKind.income;
  object.manualEditTimestamp = reader.readDateTimeOrNull(offsets[14]);
  object.merchantName = reader.readString(offsets[15]);
  object.notes = reader.readStringOrNull(offsets[16]);
  object.origin =
      _TransactionModeloriginValueEnumMap[reader.readByteOrNull(offsets[17])] ??
          TransactionOrigin.emailDetected;
  object.originalEmailId = reader.readStringOrNull(offsets[18]);
  object.rawMerchantName = reader.readStringOrNull(offsets[19]);
  object.subscriptionId = reader.readLongOrNull(offsets[20]);
  object.subtotalAmount = reader.readDoubleOrNull(offsets[21]);
  object.taxAmount = reader.readDoubleOrNull(offsets[22]);
  object.tipAmount = reader.readDoubleOrNull(offsets[23]);
  object.updatedAt = reader.readDateTimeOrNull(offsets[24]);
  object.userVerified = reader.readBool(offsets[25]);
  return object;
}
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      hasSplitsEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hasSplits',
        value: value,
      ));
    });
  }
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByHasSplits() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasSplits', Sort.asc);
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByHasSplitsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasSplits', Sort.desc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByHasSplits() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'hasSplits');
    });
  }
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, bool, QQueryOperations> hasSplitsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hasSplits');
    });
  }
